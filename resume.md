...
- **Computer Vision:** Probabilistic Image Analysis, Document Computer Vision (OCR), Visual Reasoning, Probability Map Generation  
...
- Trained supervised ML models for candidate assessment using TensorFlow, performing feature engineering and model tuning for role-specific evaluations
...
- Demonstrated symbolic AI approach to visual reasoning, identifying geometric transformations and logical patterns without deep learning
